...
```shell
python3 main.py --strategy llm_mutation --model qwen3:8b
```
...
```shell
python3 main.py --strategy baseline --list custom
```
This is result of the mutation-based baseline fuzzer that will be used for the comparative analysis with ConFuzz.
![Baseline Fuzzer Example Results](assets/images/baseline_fuzzer_example_1.png)
